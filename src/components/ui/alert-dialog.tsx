...
// No changes needed for these — they just spread props
...
// This is the one causing your error — size prop added
...
function AlertDialogAction({ className, variant = "default", size = "default", ...props }: AlertDialogActionProps) {
  return (
